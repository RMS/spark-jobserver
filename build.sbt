...
lazy val publishSettings = Seq(
    publishTo := Some("Artifactory Realm" at "http://artifactory.dev.rms-poc.com/artifactory/rms-maven-local"),
    credentials += Credentials("Artifactory Realm", "artifactory.dev.rms-poc.com", "admin", "APAoszFPd4V54byJfLx1RijBDd6")
)
